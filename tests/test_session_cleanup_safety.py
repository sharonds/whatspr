...
class TestSessionCleanupSafety(RateLimitedTestCase):
    ...
    def test_concurrent_cleanup_and_access(self):
        ...
        assert all(result == thread_id for result in access_results), \
    ...
    def test_cleanup_during_session_creation(self):
        ...
        failed_creations = [phone for phone, result in creation_results.items() 
        ...
        assert final_session_count == users_count, \
    ...
    def test_cleanup_thread_safety(self):
        ...
        assert total_removed <= expected_expired, \
