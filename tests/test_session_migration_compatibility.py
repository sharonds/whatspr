...
class TestSessionMigrationCompatibility(RateLimitedTestCase):
    ...
    def test_migrate_preserves_existing_sessions(self):
        ...
        legacy_sessions = {"+1234567890": "thread_migrated_1", "+1987654321": "thread_migrated_2"}
        ...
        assert (
            final_metrics['total_sessions_created'] == initial_metrics['total_sessions_created'] + 2
        )
    ...
    def test_migrate_overwrites_duplicate_phones(self):
        ...
        legacy_sessions = {"+1234567890": "thread_overwrite", "+1987654321": "thread_new"}
    ...
    def test_migration_after_expiration_cleanup(self):
        ...
        self.session_manager._sessions["+1000000000"] = SessionEntry(
            thread_id="thread_expired", created_at=expired_time, last_accessed=expired_time
        )
