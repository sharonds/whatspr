...
def test_menu_conversation():
    ...
    try:
        ...
        print(f"✅ Option 1 processed successfully")
        ...
        print(f"✅ Company name processed successfully")
        ...
        print(f"✅ Funding amount processed successfully")
        ...
        print(f"✅ Option 2 processed successfully")
        ...
        print(f"✅ Option 3 processed successfully")
